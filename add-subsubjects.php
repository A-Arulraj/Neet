<?php
	...
	{
		$sno = $_REQUEST['sno'];
		$sql1 = mysqli_query($conn,"select * from `exam_subsubject` where `sno` ='$sno'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Add Sub Subjects</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Sub Subjects Details</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="model/exam_subsubjects.php" method="post" autocomplete="off">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                              ...
                                                              <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
                                                                    ...
                                                                    <select class="form-control custom-select-value" name="exam_subsubject_status">
																			
                                                                  <option value="Active" <?php if(@$_fetch['exam_subsubject_status']=="Active"){echo "selected"; } ?>>Active</option>
                                                                  <option value="De-Active" <?php if(@$_fetch['exam_subsubject_status']=="De-Active"){echo "selected"; } ?>>De-Active</option>
