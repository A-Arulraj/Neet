...
<html class="no-js" lang="en">
											...
											data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
												<thead>
													<tr>
														...
														<th data-field="email">Duration`s</th>
														<th data-field="phone">Fees</th>
														<th data-field="complete">Start time</th>
														<th data-field="task">End Time</th>
												...
												<tbody>
													<?php 
														$i=0;
														$sqll=mysqli_query($conn,"select * from exam_course where flog=1") or  die('Error: ' . mysqli_error($conn));
														...
														<tr>
															...
															<td><?=$row['exam_course_duration'];?></td>
															<td><?=$row['exam_course_price'];?></td>
															<td><?=$row['exam_course_starttime'];?></td>
															<td><?=$row['exam_course_endtime'];?></td>
															<td><?=$row['exam_course_status'];?></td>
															<td>
	...
	<script>
		function seturlpath(id,act)
		{
			if(act=='edit')
			{
				var editurl = "add-course.php?act=Edit&sno="+id;
				$('#editurl').attr('href', editurl);
			}
			else
			{
				var deleteurl = "model/exam_course.php?Course=Delete&sno="+id;
