...
<html class="no-js" lang="en">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="breadcome-heading">
												<a href="add-subsubjects.php" class="btn btn-primary">Add SubSubject</a>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<ul class="breadcome-menu">
												...
												<li><span class="bread-blod">All SubSubjects</span>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="datatable-dashv1-list custom-datatable-overright">
											...
											data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
												...
												<tbody>
													<?php 
														$i=1;
														$sqll=mysqli_query($conn,"select t1.*, t2.*, t3.* from exam_subsubject as t1 left join exam_subject as t2 On t1.exam_subject_name= t2.sno left join exam_course as t3 On t1.exam_course_name = t3.sno	where t1.flag = 1 And t2.flag = 1 And t3.flog = 1") or  die('Error: ' . mysqli_error($conn));
	...
	<script>
		function seturlpath(id,act)
		{
			if(act=='edit')
			{
				var editurl = "add-subsubjects.php?act=Edit&sno="+id;
				$('#editurl').attr('href', editurl);
			}
			else
			{
				var deleteurl = "model/exam_subsubjects.php?subject=Delete&sno="+id;
