...
<html class="no-js" lang="en">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="breadcome-heading">
												<a href="add-subjects.php" class="btn btn-primary">Add Subject</a>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<ul class="breadcome-menu">
												...
												<li><span class="bread-blod">All Subjects</span>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="datatable-dashv1-list custom-datatable-overright">
											...
											data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
												...
												<tbody>
													<?php 
														$i=0;
														$sqll=mysqli_query($conn,"select exam_subject.*, exam_course.* from exam_subject, exam_course where exam_subject.flag = 1 And exam_course.flog = 1") or  die('Error: ' . mysqli_error($conn));
														...
														<tr>
															...
															<td><?=$row['exam_subject_description'];?></td>
															<td><?=$row['exam_subject_status'];?></td>
	...
	<script>
		function seturlpath(id,act)
		{
			if(act=='edit')
			{
				var editurl = "add-subjects.php?act=Edit&sno="+id;
				$('#editurl').attr('href', editurl);
			}
			else
			{
				var deleteurl = "model/exam_subjects.php?subject=Delete&sno="+id;
