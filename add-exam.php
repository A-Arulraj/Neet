<?php
	...
	{
		$sno = $_REQUEST['sno'];
		$sql1 = mysqli_query($conn,"select * from `exam_exam` where `sno` ='$sno'");
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Exam Details</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="model/exam_exam.php" method="post" autocomplete="off">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 ...
                                                                 <div class="form-group">
                                                                    <label> Exam Status </label>
                                                                      <div class="form-select-list">
                                                                        <select class="form-control custom-select-value" name="exam_exam_status">
                                                                        <option value="Active" <?php if(@$_fetch['exam_exam_status']=="Active"){echo "selected"; } ?>>Active</option>
                                                                        <option value="De-Active" <?php if(@$_fetch['exam_exam_status']=="De-Active"){echo "selected"; } ?>>De-Active</option>
                                                                        </select>
                                                                     </div>
                                                                  </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                  <div class="form-group">
                                                                      ...
                                                                      <input name="exam_exam" type="text" class="form-control" placeholder="Exam Name" value="<?=@$_fetch['exam_exam'];?>">
                                                                  </div>
                                                                  <div class="form-group">
																                                    <label> Duration </label>
                                                                    <input name="exam_duration" type="text" class="form-control" placeholder="Exam Duration" value="<?=@$_fetch['exam_duration'];?>">
                                                                 </div>

                                                                  <div class="form-group">
																                                    <label> Positive Marks </label>
                                                                    <input name="exam_positive_mark" type="text" class="form-control" placeholder="Exam Positive Mark" value="<?=@$_fetch['exam_positive_mark'];?>">
                                                                 </div>

                                                                 <div class="form-group">
																                                    <label> Negative Marks </label>
                                                                    <input name="exam_negative_mark" type="text" class="form-control" placeholder="Exam Negative Mark" value="<?=@$_fetch['exam_negative_mark'];?>">
                                                                 </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
