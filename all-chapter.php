...
<html class="no-js" lang="en">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="breadcome-heading">
												<a href="add-subsubjects.php" class="btn btn-primary">Add Chapter</a>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<ul class="breadcome-menu">
												...
												<li><span class="bread-blod">All Chapter</span>
												</li>
											</ul>
										</div>
									</div>
											...
											data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
												...
												<tbody>
													<?php 
														...
														select t1.*, t2.*, t3.*, t4.* 
														from exam_chapter as t1 
														left join exam_subsubject as t2 On t1.exam_subsubject_name = t2.sno	
														left join exam_subject as t3 On t1.exam_subject_name= t3.sno 
														left join exam_course as t4 On t1.exam_course_name = t4.sno	
														where t1.flag = 1 And t2.flag = 1 And t3.flag = 1 And t4.flog = 1"
														...
														<tr>
															...
															<td><?=$row['exam_chapter_description'];?></td>
															<td><?=$row['exam_chapter_status'];?></td>
	...
	<script>
		function seturlpath(id,act)
		{
			if(act=='edit')
			{
				var editurl = "add-chapter.php?act=Edit&sno="+id;
				$('#editurl').attr('href', editurl);
			}
			else
			{
				var deleteurl = "model/exam_chapter.php?subject=Delete&sno="+id;
