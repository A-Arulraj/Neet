...
<html class="no-js" lang="en">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="breadcome-heading">
												<a href="add-subsubjects.php" class="btn btn-primary">Add Exam</a>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											...
											data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
												<thead>
													<tr>
														...
														<th data-field="chapter">Chapter</th>
														
														<th data-field="status">Status</th>
														<th data-field="exam">Exam</th>
														<th data-field="duration">Duration</th>
														<th data-field="positive">Positive Marks</th>
														<th data-field="negative">Negative Marks</th>
												...
												<tbody>
													<?php 
														...
														from exam_exam as t1
														left join exam_chapter as t2 On t1.exam_chapter_name = t2.sno	
														left join exam_subsubject as t3 On t1.exam_subsubject_name = t3.sno	
														left join exam_subject as t4 On t1.exam_subject_name= t4.sno 
														left join exam_course as t5 On t1.exam_course_name = t5.sno	
														where t1.flag = 1 And t2.flag = 1 And t3.flag = 1 And t4.flag = 1 And t5.flog = 1"
														...
														<tr>
															...
															<td><?=$row['exam_chapter_name'];?></td>
															
															<td><?=$row['exam_exam_status'];?></td>
															<td><?=$row['exam_exam'];?></td>

															<td><?=$row['exam_duration'];?></td>
															<td><?=$row['exam_positive_mark'];?></td>
															<td><?=$row['exam_negative_mark'];?></td>
															<td>
	...
	<script>
		function seturlpath(id,act)
		{
			if(act=='edit')
			{
				var editurl = "add-exam.php?act=Edit&sno="+id;
				$('#editurl').attr('href', editurl);
			}
			else
			{
				var deleteurl = "model/exam_exam.php?subject=Delete&sno="+id;
